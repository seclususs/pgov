...
#define PASCAL_GOV_STABILIZATION_DELAY_SEC 10
#define PASCAL_GOV_BOOT_WAIT_RETRY_LIMIT 300
#define PASCAL_GOV_BOOT_POLL_INTERVAL_SEC 1
#define PASCAL_GOV_SYSFS_QUANTIZATION_NS 65536ULL
#define PASCAL_GOV_STRATEGY_LATENCY 100
#define PASCAL_GOV_STRATEGY_GRANULARITY 100
#define PASCAL_GOV_STRATEGY_WAKEUP 150
#define PASCAL_GOV_STRATEGY_MIGRATION 50000
#define PASCAL_GOV_STRATEGY_WALT 5
#define PASCAL_GOV_STRATEGY_UCLAMP 32
#define PASCAL_GOV_RT_PRIORITY 50
#define PASCAL_GOV_UCLAMP_MAX 102
#define PASCAL_GOV_STACK_SIZE (512UL * 1024UL)
#define PASCAL_GOV_TIMER_SLACK_NS (50UL * 1000UL * 1000UL)
#define PASCAL_GOV_IOPRIO_CLASS 2
#define PASCAL_GOV_IOPRIO_DATA 0
